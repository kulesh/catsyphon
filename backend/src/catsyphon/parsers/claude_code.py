...
class ClaudeCodeParser:
    ...
    # Backward-compatible delegates to plan_extraction module
    def _is_plan_file_path(self, file_path: str) -> bool:
        """Delegate to plan_extraction.is_plan_file_path."""
        return is_plan_file_path(file_path)

    def _detect_plan_mode_entry(self, content: str) -> Optional[str]:
        """Delegate to plan_extraction.detect_plan_mode_entry."""
        return detect_plan_mode_entry(content)
