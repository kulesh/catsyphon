...
class CollectorClient:
    ...
    def _message_to_event(self, msg: ParsedMessage) -> dict[str, Any]:
        """Convert a ParsedMessage to a collector event."""
        ...
        author_role = role_mapping.get(msg.role, "assistant")
        ...
        return self._create_event(
            event_type="message",
            emitted_at=msg.timestamp or datetime.now(timezone.utc),
            data=data,
        )
