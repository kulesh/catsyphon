...
class SlashCommandDetector:
    ...
    async def detect(
        ...
        try:
            ...
            # Run LLM detection
            recommendations, llm_metrics = self._detect_with_llm(canonical.narrative)
            ...
            run = run_repo.create_run(
                capability="recommendation_slash",
                ...
                prompt_version="recommendation-slash-v1",
    ...
    def _detect_with_llm(
        self, narrative: str
    ) -> tuple[list[SlashCommandRecommendation], dict[str, object]]:
