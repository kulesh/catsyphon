"""a05 — Standalone plan markdown files."""
...
def scan_standalone_plans(
    ...
    for path in sorted(base.glob("plans/*.md")):
        ...
        if change_type in ("created", "modified"):
            ...
            log.info("standalone_plans %s: %s", change_type, path)
