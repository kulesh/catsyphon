"""a02 — Project memory markdown files."""
...
def scan_project_memory(
    ...
    for path in sorted(base.glob(pattern)):
        ...
        # project_path: e.g. projects/my-proj/memory
        project_path = str(path.parent.relative_to(base))
        body = {
        ...
        if change_type in ("created", "modified"):
            ...
            log.info("project_memory %s: %s", change_type, path)
